...
implicit none
! PARAMETERS
integer, parameter :: nvx = 604 ! 40 !60	!! MAX # of Model Levels
...
fi%lscm	   = (/ .false., .false., .true., .false. /) ! USE all  SOLVER MODES ( CLEAR,TOTAL ,Pristine,NoaotCld )
...
!clouds set to 0
fi%fc(:)%cldfrac   = 0.0    ! Cloud Fraction (0-1) 
